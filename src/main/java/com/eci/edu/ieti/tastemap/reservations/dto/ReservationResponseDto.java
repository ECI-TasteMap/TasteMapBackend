...
public class ReservationResponseDto {
    ...
    /**
     * Backwards-compatible constructor without `status` for existing tests.
     */
    public ReservationResponseDto(String id, String userId, String restaurantId, String locationId,
